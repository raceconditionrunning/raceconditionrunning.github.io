...
export function formatLegDescription(startStation, endStation, leg){
    return `<h5>${startStation} to ${endStation}</h5><h6>${leg.distance_mi.toFixed(2)}mi ↑${leg.ascent_ft.toFixed(0)}ft ↓${leg.descent_ft.toFixed(0)}ft</h6><p class="mb-0">${leg.notes}</p>`
}

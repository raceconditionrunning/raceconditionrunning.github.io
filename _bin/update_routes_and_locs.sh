...
python $SCRIPT_DIR/update_route_neighborhoods.py
...
mv $SCRIPT_DIR/tmp/bus/stops.txt $SCRIPT_DIR/../routes/seattle_transit_data/bus.csv

wget -c $LIGHT_RAIL_PATH -O $SCRIPT_DIR/tmp/light_rail.zip
unzip -o $SCRIPT_DIR/tmp/light_rail.zip -d $SCRIPT_DIR/tmp/light_rail
mv $SCRIPT_DIR/tmp/light_rail/stops.txt $SCRIPT_DIR/../routes/seattle_transit_data/light_rail.csv

rm -rf $SCRIPT_DIR/tmp/
python $SCRIPT_DIR/update_location_transit.py